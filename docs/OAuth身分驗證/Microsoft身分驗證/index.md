...
本篇使用說明協助開發人員，在專案裡使用MDP.AspNetCore.Authentication.Microsoft所提供的Microsoft身分驗證。
...
服務申請完成之後，就可以開始建立專案。MDP.AspNetCore.Authentication.Microsoft預設獨立在MDP.Net專案範本外，依照下列操作步驟，即可建立加入MDP.AspNetCore.Authentication.Microsoft的專案。
