    ...
    public class AzureUserHandler : OAuthHandler<AzureUserOptions>
    {
        ...
        protected override async Task<OAuthTokenResponse> ExchangeCodeAsync(OAuthCodeExchangeContext context)
        {
            ...
            if (response.IsSuccessStatusCode == false)
            {
                ...
                if (string.IsNullOrEmpty(content) == true) throw new HttpRequestException($"An error occurred when retrieving AzureUser user information ({response.StatusCode}). Please check if the authentication information is correct.");
            }
