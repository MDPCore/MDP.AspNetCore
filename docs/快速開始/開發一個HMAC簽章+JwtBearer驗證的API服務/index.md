---
layout: default
title: 開發一個HMAC簽章+JwtBearer驗證的API服務
parent: 快速開始
grand_parent: 身分驗證
nav_order: 3
has_children: false
...
![03.GetUser01.png](https://clark159.github.io/MDP.AspNetCore.Authentication/快速開始/開發一個HMAC簽章+JwtBearer驗證的API服務/03.GetUser01.png)