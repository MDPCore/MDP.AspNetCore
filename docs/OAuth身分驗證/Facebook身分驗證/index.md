...
![01.建立Application01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/01.建立Application01.png)

![01.建立Application02.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/01.建立Application02.png)

![01.建立Application03.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/01.建立Application03.png)
...
![02.設定Application01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/02.設定Application01.png)

![02.設定Application02.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/02.設定Application02.png)

![02.設定Application03.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/02.設定Application03.png)

3.同樣於Application頁面，點擊左側選單，進入使用案例頁面後，點擊驗證和帳號建立流程的編輯按鈕，依照頁面提示新增email權限。

![03.設定Scope01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/03.設定Scope01.png)

![03.設定Scope02.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/03.設定Scope02.png)

4.同樣於Application頁面，點擊左側選單，進入應用程式設定/基本資料頁面後，依照頁面提示取得「應用程式編號」、「應用程式密鑰」。

![04.取得參數01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/04.取得參數01.png)
...
- 範例下載：[WebApplication1.zip](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/WebApplication1.zip)
...
3.依照[模組使用-申請服務](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/#模組使用)的步驟流程，申請Facebook身分驗證服務，並取得「應用程式編號」、「應用程式密鑰」。

![05.申請服務01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/05.申請服務01.png)
...
![06.LoginPage01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/06.LoginPage01.png)

8.於Login頁面，點擊LoginByFacebook按鈕。Browser視窗會跳轉至Facebook身分驗證服務的頁面，進行OAuth身分驗證。

![07.OAuthPage01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/07.OAuthPage01.png)

9.於Facebook身分驗證服務完成身分驗證之後，Browser視窗會跳轉回原系統的Home頁面，並且顯示登入的身分資料。(經由Facebook身分驗證登入)

![08.HomePage01.png](https://mdpcore.github.io/MDP.AspNetCore/OAuth身分驗證/Facebook身分驗證/08.HomePage01.png)