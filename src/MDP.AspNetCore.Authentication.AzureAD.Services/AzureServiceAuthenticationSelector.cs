...
{
    public class AzureServiceAuthenticationSelector : PolicyAuthenticationSelector
    {
        // Fields
        ...
        // Constructors
        public AzureServiceAuthenticationSelector(string scheme, string header, string prefix = null)
        {
            #region Contracts
